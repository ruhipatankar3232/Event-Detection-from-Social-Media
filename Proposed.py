...
# Define Improved Piranha Foraging Optimization Algorithm (PFOA)  -> Updation Starts from line no 32
def Proposed(search_space, objective_function, lb, ub, iterations):
    ...
    for i in range(iterations):
        ...
        for j in range(len(population)):
            ...
            velocity =  best_fitness/ max(current_best_fitness)#np.random.uniform(-1, 1, (dimensions,))
